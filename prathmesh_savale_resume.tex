...
\headedsection  % sets the header for the section and includes any subsections
  ...
  \headedsubsection
	...
	{Forecasting gasoline and electricity consumption for private vehicles} {%
		...
		\item Created a parser in \acr{R} to extract relevant information such as vehicle miles traveled, fuel consumption, vehicle type, 			etc. from various government and public survey websites.
		\end{itemize}
		}}
	}
%	\inhouseprojectsection 
